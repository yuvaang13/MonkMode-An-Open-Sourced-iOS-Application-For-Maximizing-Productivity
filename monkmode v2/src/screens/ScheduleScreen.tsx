 ...
 * ScheduleScreen.tsx
 *
 * Configure recurring focus schedules that run without opening the app.
    ...
    <ScrollView style={S.screen} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View key={schedule.id} style={styles.card}>
          ...
          >
            ...
            <Switch
              ...
              onValueChange={v => toggleSchedule(schedule.id, v)}
      ...
      <View style={styles.note}>
        <Text style={styles.noteText}>
          Schedules enforce restrictions automatically via iOS DeviceActivity.
          MonkMode does not need to be open.
        </Text>
      </View>
    </ScrollView>
  )
